    ...
    <div className="pointer-events-auto absolute inset-0 flex items-end justify-center bg-bg/20 p-4 pb-8 sm:items-center">
      ...
      <div className="relative z-20 w-full max-w-lg rounded-xl border border-border bg-surface/90 p-6 shadow-lg sm:p-8">
        ...
        {!challenge && mode === "mafia" && (
          <ul className="mt-4 space-y-1 text-sm text-fg">
            <li>Run the boardwalk. Extort respect from vendors.</li>
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <section className="rounded-lg border border-[#c45c4a]/50 bg-[#c45c4a]/5 p-4">
            ...
            <dl className="mt-3 space-y-3 text-sm leading-relaxed">
              ...
              <div><dt className="font-medium text-fg">Objective</dt><dd className="text-muted">Chain tribute for more respect, then bank it at the glowing Den before cats steal it. Armed scores use their own blotter.</dd></div>
            </dl>
          </section>
        </div>
...
function Hud() {
  ...
  return (
    <>
      ...
      <div className="absolute top-1/2 left-1/2 size-8 -translate-x-1/2 -translate-y-1/2 opacity-70">
